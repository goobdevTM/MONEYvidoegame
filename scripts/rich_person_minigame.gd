...
var questions : Array[Dictionary] = [
	{'q': "What?", 'good': 'Trust me, I can explain...', 'bad': "I don't know!"},
	{'q': "Are you a fool?", 'good': "Of course not!", 'bad': "Maybe..."},
	{'q': "Are you a foul beast?", 'good': 'Nopeity schmope!', 'bad': "Trust me, I can explain..."},
]
...
func ask_question() -> void:
	...
	buttons.get_child(good).text = questions[question_int]['good']
	buttons.get_child(posmod(good + 1, 2)).text = questions[question_int]['bad']
